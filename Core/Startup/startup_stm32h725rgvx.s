...
.section .text.LoadRamSection
.type  LoadRamSection, %function
/*
	Copies initialization data from a section in flash to a section in RAM

	r0 = start address in flash
	r1 = end address in flash
	r2 = start address in RAM section
...
LoadRamSectionLoop:
	adds r4, r0, r3
	cmp r4, r1
	bcs LoadRamSectionEnd

	ldr r4, [r2, r3]
	str r4, [r0, r3]

	adds r3, r3, #4
	b LoadRamSectionLoop
LoadRamSectionEnd:
	bx lr

.size LoadRamSection, .-LoadRamSection

.section .text.FillRamSection
.type  FillRamSection, %function

/*
	Fills a section of RAM with a value
...
.size FillRamSection, .-FillRamSection

.section .text.ZeroRamSection
.type  ZeroRamSection, %function

/*
	Zero fills a section of RAM
...
.size ZeroRamSection, .-ZeroRamSection
