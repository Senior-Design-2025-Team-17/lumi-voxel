set(WINDOWS_ST_CLT_PATH "C:/ST/STM32CubeCLT_1.18.0/GNU-tools-for-STM32/bin")
...
set(FLAGS                           "-Wl,--gc-sections -static -fdata-sections -ffunction-sections -u _printf_float --specs=nano.specs -fstack-usage -fcyclomatic-complexity -flto=auto")
...
set(CPP_FLAGS                       "-std=gnu++23 -fno-rtti -fno-exceptions -fno-threadsafe-statics -fno-use-cxa-atexit -Woverloaded-virtual -Wnon-virtual-dtor -Wsuggest-override")
